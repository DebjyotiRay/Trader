...
#
#
# model_a2c = agent2.train_model( model_a2c, "a2c", tb_log_name=f"a2c_{i}", iter_num=i,total_timesteps=100000,)  # 100_000
...
class DRLEnsembleAgent:
    ...
    def get_model(
        ...
        if model_name not in MODELS:
            print("aapka diya hua to hai nahi, to hum ppo hi le rahe hain")
            model_name="ppo"
            # raise ValueError(
            #     f"Model '{model_name}' not found in MODELS."
            # )  # this is more informative than NotImplementedError("NotImplementedError")
...
# print("turbulence_threshold: ", turbulence_threshold)
last_state_ensemble = []
last_state_ensemble= agent.DRL_prediction(
                model="ppo",
                name="ensemble",
                last_state=last_state_ensemble,
                iter_num=65,
