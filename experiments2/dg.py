...
>>>>>>> 2e15bbbd54a88aa85ac0c48349edde475eb639a9:experiments/finrl/meta/env_stock_trading/env_stocktrading.py
...
<<<<<<< HEAD:dg.py
                ...
                try:
                    ...
                    print("Error occurred while accessing elements:", e)
                    # Handle the error here, such as setting available_amount to a default value or logging the error.
                    # For example:
                    # available_amount = 0  # Set available_amount to a default value
                    # Or
                    # logging.error("Error occurred while accessing elements: %s", e)
=======
                available_amount = self.state[0] // (
                    self.state[index + 1] * (1 + self.buy_cost_pct[index])
                )  # when buying stocks, we should consider the cost of trading when calculating available_amount, or we may be have cash<0
