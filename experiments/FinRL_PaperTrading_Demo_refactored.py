...
TRADING_API_KEY = ALPACA_API_KEY_ID
TRADING_API_SECRET = ALPACA_API_SECRET_KEY
...
#     break_step=1e5,
# )
#ab ye kar raha hun for stablebaselines3:
...
print("PEHLI BAAR KA TRAINING KHATAM HUA")


print("TESING TO KARNE DE BHAI")
account_value = test(
...
print("YE CHECKING THE ACCOUNT VALUE OVER TIME WRT THE TRAINED MODEL")
train(
...
print("PAPER TRADING WITH REAL DATA ON ALPACA NOW:   ")
